...
const expansionSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "We prioritize material knowledge, helping you navigate the various 'tiers' of composite-from basic scalloped-back boards to ultra-premium solid-core PVC. Each has its place depending on your project's vertical architecture and budget. For instance, if you're building a deck with an integrated fire pit or outdoor kitchen, certain high-heat resistant composites are mandatory.",
      "Beyond just the boards, we utilize hidden fastener systems. These industrial-grade clips are installed between the gaps of the boards, meaning there are no visible screws on the surface of your deck. This creates a smooth, barefoot-friendly floor that is safer for children and pets, and provides the premium, seamless look expected in areas like Great Falls and Mclean."
    ],
    listItems: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "We provide our clients with a custom maintenance guide for their specific composite brand, ensuring they know exactly how to care for their investment for maximum longevity."
    ]
  },
  {
    ...
    paragraphs: [
      ...
      "Choosing a composite deck builder near you who is dedicated to this material means you are getting an expert who knows exactly how to handle thermal expansion, fastener torquing, and color matching in our specific Mid-Atlantic environment."
    ]
  }
];
  ...
  return (
    <main>
      ...
      <ServiceInclusions 
        ...
        description="Our composite builds are designed for Northern Virginia's climate."
        items={inclusions}
      />
