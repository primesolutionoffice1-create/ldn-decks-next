...
const loudounFAQs = [
    ...
    },
    {
            ...
            a: "Loudoun Decks is proud to be a 5-Star Google Rated company, recognized for transparency and premium quality across the county."
    },
    {
...
const expansionSections = [
    {
            ...
            paragraphs: [
                      ...
                      "We understand the unique architectural standards of our region. From the classic brick colonials of Sterling to the modern, open-concept designs in Brambleton, we ensure your outdoor space is a seamless continuation of your home's interior luxury. Our professional team is known for taking full projects only, ensuring that every detail from the initial foundation to the final lighting fixture is handled with professional care.",
    ...
    },
    {
            ...
            paragraphs: [
                      ...
                      "We take pride in our transparency. When we provide a quote for your project, it includes every permit fee, every drawing, and every material cost. There are no hidden surprises — just an honest, professional path to your new outdoor living space."
                    ]
    },
    {
            title: "Why Premium Craftsmanship Matters",
            paragraphs: [
                      "In a service industry, reputation is everything. Our commitment to quality is not just a badge; it's a promise to the families of Loudoun County. It means that from the moment you contact us for a consultation through the final cleanup, you will receive expert communication and unmatched craftsmanship. We prioritize quality over volume, taking on a selective number of full-scale construction projects each year to ensure every site gets the attention it deserves.",
                      "Our builds feature high-end materials like Trex Transcend and premium Western Red Cedar. We utilize hidden fasteners and precision mitering to ensure that the final result is as clean as a piece of indoor furniture. For our clients in Fairfax County and Prince William County, this commitment to premium quality ensures that their outdoor space remains a source of pride for 20 years or more.",
                      "We invite you to explore our gallery of local projects across NoVA. Whether you're in the heart of the tech corridor or the quiet of the Loudoun countryside, we are ready to turn your backyard into a top-rated retreat."
                    ]
    }
    ];
...
export default function DeckBuildersLoudounPage() {
      return (
          ...
          />
            ...
            description="Trusted deck builder serving Loudoun, Fairfax & Prince William counties. Trex Platinum Partner. Top-rated. Free estimates."
            items={inclusions}
          />
                      <ProcessSteps />
                      <ServicesFAQ
