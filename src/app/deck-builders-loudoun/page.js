...
const expansionSections = [
  ...
  },
  {
    ...
    paragraphs: [
      "In a service industry, reputation is everything. Our 5-Star Google Rated status is not just a badge; it's a promise to the families of Loudoun County. It means that from the moment you contact us for a consultation in Potter's Corner through the final cleanup in Lucketts, you will receive expert communication and unmatched craftsmanship. We prioritize quality over volume, taking on a selective number of full-scale construction projects each year to ensure every site gets the attention it deserves.",
      "Our builds feature high-end materials like Trex Transcend and premium Western Red Cedar. We utilize hidden fasteners and precision mitering to ensure that the final result is as clean as a piece of indoor furniture. For our clients in Fairfax County and Prince William County, this commitment to high-ticket quality ensures that their outdoor space remains a source of pride for 20 years or more. We are positioning Loudoun Decks as the last deck builder you will ever need to hire.",
  ...
  return (
    <main>
      <ServicesHeader 
        ...
        description="Loudoun Decks is a 5-Star Google Rated builder specializing in high-end composite and wood decks in Ashburn, Leesburg, and across Loudoun County. 1,500+ words of expertise."
      />

      <ServiceMain 
        subtitle="Hyper-Local Expertise"
        title="Your Trusted Loudoun County Deck Contractor"
        description="Build with a team that knows Loudoun. We specialize in navigating local HOAs and building codes for homes in Arlington, Stafford, and total Northern Virginia."
        listItems={[
