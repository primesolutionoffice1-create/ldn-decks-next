          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'start' }}>
            ...
            <div style={{ background: '#f8fafc', padding: '2.5rem', borderRadius: '16px', border: '1px solid #e2e8f0' }}>
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                />
                <div style={{ fontSize: '2rem', fontWeight: 800, color: '#3182ce' }}>{fmt(cost)}</div>
              </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ background: '#ebf8ff', padding: '1.5rem', borderRadius: '12px', marginBottom: '2rem' }}>
                <p style={{ margin: 0, fontWeight: 700, color: '#2b6cb0' }}>
