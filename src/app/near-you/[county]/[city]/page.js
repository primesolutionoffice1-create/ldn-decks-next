        ...
        <section className={styles.localFocus}>
          <div className={styles.container}>
            <div className={styles.content}>
              ...
              <p style={{ marginTop: '16px' }}>{localContent.localContext}</p>
