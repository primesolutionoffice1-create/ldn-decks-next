...
export const metadata = {
  title: "Deck Builder in Fairfax County, VA | Reston & Vienna | Loudoun Decks",
...
const fairfaxCities = [
  ...
  "Oakton, VA", "Great Falls, VA", "Lorton, VA", "Tysons, VA", "West Springfield, VA"
];
...
const faqs = [
  {
    q: "Do you work throughout all of Fairfax County?",
    a: "Yes. We serve homeowners across Fairfax County, including Alexandria, Fairfax, Vienna, Reston, Herndon, Mclean, Falls Church, Annandale, Burke, Springfield, Chantilly, Centreville, Oakton, Great Falls, Lorton, Tysons, West Springfield and nearby communities."
  },
  {
    q: "How much does a new deck typically cost in Fairfax County?",
  ...
  },
  {
    ...
    a: "Yes. For projects that require permits in Fairfax County, we help prepare the necessary information and coordinate with the county as part of the project."
  },
  {
...
export default function FairfaxCountyPage() {
  return (
    <main>
      ...
      <ServicesFAQ 
        title="Frequently Asked Questions About Decks in Fairfax County"
        faqs={faqs}
      />
