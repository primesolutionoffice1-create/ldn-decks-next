    ...
    <main style={{ background: '#fff', color: '#1a202c' }}>
      <section style={{ background: '#1a1a2e', color: '#fff', padding: '5rem 0' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 1.5rem' }}>
          <span style={{ background: '#3182ce', padding: '4px 12px', borderRadius: '4px', fontSize: '0.9rem', fontWeight: 700 }}>2026 ANNUAL DATA</span>
      ...
      <section style={{ padding: '4rem 0' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <div style={{ textAlign: 'center', padding: '4rem', background: '#1a1a2e', color: '#fff', borderRadius: '12px' }}>
             ...
             <Link href="/deck-cost-calculator" style={{ background: '#3182ce', color: '#fff', padding: '15px 40px', borderRadius: '8px', textDecoration: 'none', fontWeight: 700, fontSize: '1.1rem' }}>
