...
const expansionSections = [
  {
    ...
    paragraphs: [
      ...
      "Choosing a fence contractor near you who handles the entire process-including utility marking and HOA coordination-is vital. Our team ensures that your fence is perfectly level, structurally stable, and built to withstand the Mid-Atlantic’s seasonal shifts. From traditional wood pickets to modern horizontal slat designs, our skilled craftsmen treat every post with precision."
    ]
  },
  {
    ...
    paragraphs: [
      ...
      "Vinyl (PVC) fencing is the ultimate low-maintenance solution for busy families in Arlington and Stafford. Modern vinyl is engineered with UV inhibitors that prevent yellowing and brittle breakdown. It is a 'set it and forget it' material that only requires a seasonal wash with a hose. For those looking for a contemporary look, we often install black aluminum fencing, which provides a sophisticated, 'wrought iron' look that won't rust and offers maximum visibility into the surrounding landscape.",
      "As your custom deck builder and fencing expert, we help you weigh these material choices against your property's specific needs-whether that’s absolute privacy from neighbors or a secure perimeter for your dog to roam freely in Gainesville or Manassas."
    ],
    listItems: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "We provide the detailed site plans, material specifications, and architectural drawings required by most HOA boards. Our project managers are familiar with the specific quirks of major developments across Northern Virginia, ensuring that your application is approved on the first attempt. This expertise is a hallmark of a professional contractor and saves our clients weeks of bureaucratic frustration.",
      "By managing the permitting and zoning requirements for our larger service area-including Arlington and Stafford-we ensure that your fence installation is legal, insured, and compliant with all local ordinances."
    ]
  },
  {
    ...
    paragraphs: [
      ...
      "Our 'Full projects only' philosophy means we focus on these complex, integrated builds that require professional engineering and a top-rated eye for detail. We are the premier fence company near you for homeowners who refuse to settle for standard, uninspired property boundaries."
    ]
  }
];
  ...
  return (
    <main>
      ...
      <ServiceInclusions
        ...
        description="Our fences are built to last in the Mid-Atlantic climate."
        items={inclusions}
      />
