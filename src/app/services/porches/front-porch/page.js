...
const faqs = [
  { q: "Does a front porch add value to my home?", a: "Yes, a well-designed front porch is one of the highest ROI outdoor projects, significantly improving curb appeal." },
  { q: "Can you add a roof to my existing front steps?", a: "In many cases, yes. We can design a portico or a full front porch roof that integrates with your current structure." }
  ];
