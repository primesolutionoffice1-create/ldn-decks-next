...
const faqs = [
  { q: "Can I convert an existing deck into an open porch?", a: "In many cases, yes. We can evaluate your deck's structure to see if it can support a roof system." },
  { q: "What materials do you use for the ceiling?", a: "We offer various finishes including tongue-and-groove cedar, beadboard, and low-maintenance VPC." }
  ];
