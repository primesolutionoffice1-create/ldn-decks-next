...
const expansionSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "As your custom deck builder and window specialist, we ensure that your new windows are perfectly integrated with your home’s existing architecture, whether you are in a classic brick colonial in Gainesville or a contemporary townhouse in Reston."
    ],
    listItems: [
  ...
  return (
    <main>
      ...
      <ServiceInclusions 
        ...
        description="Our windows are built for heat, cold, and quiet."
