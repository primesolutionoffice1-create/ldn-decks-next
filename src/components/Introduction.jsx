      ...
      <div className={styles.container}>
        ...
        <div className={styles.imagesCol}>
          <div className={styles.subImgWrapper}>
            <Image src="/intro_sub.png" alt="Relaxing deck" fill className={styles.imgProps} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
          </div>

          <div className={styles.frameOutline}></div>

          <div className={styles.mainImgWrapper}>
            <Image src="/intro_main.png" alt="Decking experts" fill className={styles.imgProps} sizes="(max-width: 768px) 100vw, 50vw" />
          </div>
        </div>
